...
<div style="background: url('<?php echo get_template_directory_uri() . '/assets/bg.png'  ?>' ) no-repeat; background-size:100% 100%;padding:25px">
...
<main id="primary " class="md:container mx-auto my-8">
                        ...
                        <div class="w-20 h-20 relative ml-6">
                            ...
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="icon icon-tabler icon-tabler-file-certificate w-8 h-8" viewBox="0 0 24 24"
